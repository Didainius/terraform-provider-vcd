---
layout: "vcd"
page_title: "Cloud Director: vcd_vapp_access_control"
sidebar_current: "docs-vcd-resource-vapp-access-control"
description: |-
  Provides a Cloud Director Access Control structure for a vApp.
---

# vcd\_vapp\_access\_control

Provides a Cloud Director Access Control structure for a vApp. This can be used to create, update, and delete access control structures for a vApp.
