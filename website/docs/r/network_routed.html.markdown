...
description: |-
  Provides a Cloud Director Org VDC routed Network. This can be used to create, modify, and delete internal networks for vApps to connect.
---

# vcd\_network\_routed

Provides a Cloud Director Org VDC routed Network. This can be used to create,
