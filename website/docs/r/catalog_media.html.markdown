---
layout: "vcd"
page_title: "Cloud Director: vcd_catalog_media"
sidebar_current: "docs-vcd-resource-catalog-media"
description: |-
  Provides a Cloud Director media resource. This can be used to upload and delete media (ISO) file inside a catalog.
---

# vcd\_catalog\_media

Provides a Cloud Director media resource. This can be used to upload media to catalog and delete it.
