...
description: |-
  Provides a Cloud Director Organization resource. This can be used to create  delete, and update an organization.
---

# vcd\_org

Provides a Cloud Director Org resource. This can be used to create, update, and delete an organization.
