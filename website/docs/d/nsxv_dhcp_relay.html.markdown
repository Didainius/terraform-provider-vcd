...
Provides a Cloud Director Edge Gateway DHCP relay configuration data source. The DHCP relay
capability provided by NSX in Cloud Director environment allows to leverage existing DHCP
infrastructure from within Cloud Director environment without any interruption to the IP address
