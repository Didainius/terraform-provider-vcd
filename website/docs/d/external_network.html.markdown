---
layout: "vcd"
page_title: "Cloud Director: vcd_external_network"
...
Provides a Cloud Director external network data source. This can be used to reference external networks and their properties.
