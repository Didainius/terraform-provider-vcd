...
description: |-
  Provides a Cloud Director Organization user data source. This can be used to read organization users.
---

# vcd\_org\_user

Provides a Cloud Director Org User data source. This can be used to read organization users, including org administrators.
