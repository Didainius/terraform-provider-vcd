---
layout: "vcd"
page_title: "Cloud Director: vcd_independent_disk"
...
Provides a Cloud Director Independent disk data source. A independent disk data source can be used to reference an independent disk and use its 
