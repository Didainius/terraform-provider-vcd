---
layout: "vcd"
page_title: "Cloud Director: vcd_org_vdc"
...
Provides a Cloud Director Organization VDC data source. An Organization VDC can be used to reference a VCD and use its 
